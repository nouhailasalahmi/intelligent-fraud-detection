...
def get_llm_provider() -> LLMProvider:
    """
    Factory instanciant le fournisseur LLM configuré via les variables d'environnement.
    Supporte : 'ollama', 'openai', 'mistral', 'anthropic'.
    """
    ...
    if provider_name == "ollama":
        ...
        raise ValueError(f"Provider LLM inconnu : {provider_name}")
